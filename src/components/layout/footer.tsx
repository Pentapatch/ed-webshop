...
const Footer: React.FC<FooterProps> = () => {
  return (
    <footer className="bg-button-green text-border-beige h-[400px] md:h-[516px] flex absolute w-full justify-center">
      <div className="w-full md:w-3/4 h-full flex items-center absolute">
        <div className="flex justify-evenly md:justify-between w-full h-[360px]">
          ...
          />
          <div>
            <h6 className="font-brandonGrotesque font-bold text-xl uppercase mb-6">
              Information
            </h6>
